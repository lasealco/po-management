...
Product-facing map of the **next tranche** after R2 staging: compare polish, overview metrics freshness, scenario list/lifecycle, explorer export/load UX, catalog list filters, twin API observability refinements, Prisma hot-path tuning, compare-friendly seeds, and short onboarding docs. **Slice-by-slice acceptance criteria** live in **[One-agent milestones (slices 1–67)](agent_milestones_one_agent.md)** (focus **48–67**).
