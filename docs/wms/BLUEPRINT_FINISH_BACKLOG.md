...
3. For **`BF-21` … `BF-30`** next-wave objectives — shipped rows through **BF-26** in [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md); **BF-27**–**BF-30** draft catalog continues in [`BLUEPRINT_FINISH_BACKLOG.md`](./BLUEPRINT_FINISH_BACKLOG.md).
