...
| **BF-52** | **Slotting ABC / velocity recommendations** — **draft:** advisory bin-move export from velocity + pick-face rules | Slotting / bin assignment row | **BF-07**/20 movement aggregates | [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) §BF-52 — **`GET /api/wms/slotting-recommendations`**; robot solver backlog | WMS |
...
**Do not bundle **`BF-02`–`BF-11`**, **`BF-12`–`BF-20`**, **`BF-21`–`BF-32`**, nor **`BF-52`–`BF-70`** into one prompt:** each row is a **separate** thematic capsule. Mega-phase definitions: [`BF12_BF20_MEGA_PHASES.md`](./BF12_BF20_MEGA_PHASES.md) (BF-12–BF-20), [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md) (BF-21–BF-30), [`BF31_BF50_MEGA_PHASES.md`](./BF31_BF50_MEGA_PHASES.md) (BF-31–BF-50), [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) (**BF-51** shipped minimal · **draft** BF-52–BF-70).
