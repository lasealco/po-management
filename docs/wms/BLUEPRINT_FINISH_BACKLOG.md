...
| **BF-21** | **Receipt accounting & ASN policies** — **minimal landed:** closed **`WmsReceipt`** history + idempotent close + optional **`RECEIPT_COMPLETE`** on close (**BF-31** adds dock GRN + ASN qty tolerance — [`WMS_RECEIVING_BF31.md`](./WMS_RECEIVING_BF31.md)) | Inbound / receiving row | BF-12 dock receipt | [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md) §BF-21 + [`WMS_RECEIVING_BF21.md`](./WMS_RECEIVING_BF21.md); carrier ASN hub / centralized GRN / accrual backlog | WMS (+ finance alignment) |
