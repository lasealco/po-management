...
| **BF-53** | **Labor standards & task timing** — **draft:** standard minutes + optional task timestamps for KPI depth | Labor / productivity row | **`WmsTask`** (or equivalent) | [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) §BF-53 — columns + exec KPI extension; LMS/WFM backlog | WMS |
...
**Do not bundle **`BF-02`–`BF-11`**, **`BF-12`–`BF-20`**, **`BF-21`–`BF-32`**, nor **`BF-53`–`BF-70`** into one prompt:** each row is a **separate** thematic capsule. Mega-phase definitions: [`BF12_BF20_MEGA_PHASES.md`](./BF12_BF20_MEGA_PHASES.md) (BF-12–BF-20), [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md) (BF-21–BF-30), [`BF31_BF50_MEGA_PHASES.md`](./BF31_BF50_MEGA_PHASES.md) (BF-31–BF-50), [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) (**BF-51**/**BF-52** shipped minimal · **draft** BF-53–BF-70).
