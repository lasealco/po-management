...
| **BF-54** | **Yard detention & trailer clock alerts** — **draft:** detention timers from dock milestones | Dock / yard row | **BF-05**, **BF-38** | [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) §BF-54 — policy JSON + **`evaluate_dock_detention`**; carrier billing backlog | WMS (+ CT alerts) |
| **BF-55** | **Stock transfer orders & in-transit ledger** — **draft:** inter-warehouse STO + in-transit bucket | Inter-site inventory row | Outbound/inbound linkage, **BF-36** optional | [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) §BF-55 — **`WmsStockTransfer`** ship/receive; multi-leg ocean backlog | WMS |
...
**Do not bundle **`BF-02`–`BF-11`**, **`BF-12`–`BF-20`**, **`BF-21`–`BF-32`**, nor **`BF-54`–`BF-70`** into one prompt:** each row is a **separate** thematic capsule. Mega-phase definitions: [`BF12_BF20_MEGA_PHASES.md`](./BF12_BF20_MEGA_PHASES.md) (BF-12–BF-20), [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md) (BF-21–BF-30), [`BF31_BF50_MEGA_PHASES.md`](./BF31_BF50_MEGA_PHASES.md) (BF-31–BF-50), [`BF51_BF70_MEGA_PHASES.md`](./BF51_BF70_MEGA_PHASES.md) (**BF-51**/**BF-52**/**BF-53** shipped minimal · **draft** BF-54–BF-70).
