...
3. For **`BF-21` … `BF-30`** next-wave objectives — shipped rows through **BF-23** in [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md); **BF-24**–**BF-30** draft catalog continues in [`BLUEPRINT_FINISH_BACKLOG.md`](./BLUEPRINT_FINISH_BACKLOG.md).
...
_Last updated: 2026-05-03 — **BF-23** allocation reserve pick-face minimal ([`WMS_ALLOCATION_BF23.md`](./WMS_ALLOCATION_BF23.md)); **BF-22** CPQ contracted pricing minimal ([`WMS_CPQ_CONTRACT_PRICING_BF22.md`](./WMS_CPQ_CONTRACT_PRICING_BF22.md)); **`BF-21`–`BF-30`** catalog rows + [`BF21_BF30_MEGA_PHASES.md`](./BF21_BF30_MEGA_PHASES.md); **2026-05-02** — **BF-20** KPI proxy rates landed; **`BF-12`–`BF-20`** in [`BF12_BF20_MEGA_PHASES.md`](./BF12_BF20_MEGA_PHASES.md); **`BF-02`–`BF-23`** [`BF_CAPSULE_ROADMAP.md`](./BF_CAPSULE_ROADMAP.md); BF-01 prompt template._
