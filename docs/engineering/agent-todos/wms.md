...
- [x] **Commercial quotes** (R3 Phase C) — **WE-07** + **BF-10** + **BF-14** + **BF-22**: [`WMS_COMMERCIAL_HANDOFF.md`](../../wms/WMS_COMMERCIAL_HANDOFF.md) (bill-to **`crmAccountId`** + optional **`sourceCrmQuoteId`** + **`CrmQuoteLine.inventorySku`** / **`explode_crm_quote_to_outbound`**; optional **`listUnitPrice`** / **`priceTierLabel`** + **`OutboundOrderLine.commercial*`** — [`WMS_CPQ_CONTRACT_PRICING_BF22.md`](../../wms/WMS_CPQ_CONTRACT_PRICING_BF22.md)); full CPQ configurator backlog.
