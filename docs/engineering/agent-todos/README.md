...
- [Next agent sessions (eight slices)](../agent-sessions-next-7.md) — follow-on 45–75 min work + **Session 8 API hub Phase 1** + copy-paste prompts.
- [**Control Tower + WMS phased roadmap**](../CONTROL_TOWER_WMS_PHASED_ROADMAP.md) — how to sequence CT and WMS work in **phases 0–3** (hygiene → CT verticals → WMS continuation → operations map epic).
