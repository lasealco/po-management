...
| 2026-04-20 | **Tests**: **`inbound-webhook.test.ts`** — Vitest for **`processControlTowerInboundWebhook`** (idempotency replay via **`CtAuditLog`**, **`carrier_webhook_v1`** row cap + **`maxBatchRows`**, **`generic_carrier_v1`** / **`visibility_flat_v1`** / **`tms_event_v1`** happy paths, **400** shape errors without Prisma shipment reads). GitHub **#9**. |
