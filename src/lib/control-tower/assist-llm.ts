...
async function fetchLlmAssistPatch(params: {
  ...
  const system = [
    ...
    "suggestedFilters may include only these keys when you are confident: q, mode, status, onlyOverdueEta, shipperName, consigneeName, lane, originCode, destinationCode, routeAction, shipmentSource, dispatchOwnerUserId, supplierId, customerCrmAccountId, carrierSupplierId.",
