...
export function buildContractOceanBasket(params: {
  ...
  const ANCILLARY =
    /\b(baf|caf|lss|pss|thc|wfg|wharf|gate|war risk|documentation|doc fee|isps|pcs|gri|ecc|ebs|ems|dthc|othc|cfs|vgm|seal|bl fee|bill of lading|handling|pier|los|congestion|surcharge)\b/i;
