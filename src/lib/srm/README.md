...
| **Documents** | `supplier-document-parse.ts`, `supplier-document-expiry.ts` |
| **Compliance signals** | `supplier-compliance-document-signals.ts` (summary + `listComplianceDocumentFindings` + `activeDocumentNeedsComplianceAttention`), `compliance-review-due.ts` |
