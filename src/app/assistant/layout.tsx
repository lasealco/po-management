    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        <p className="mt-2 max-w-3xl text-sm text-zinc-600">
          ...
          <strong>Sprint 23</strong> is Contract Lifecycle &amp; Commercial Obligations (same workspace as AMP23 Contracts) for supplier documents, tariff contracts, RFQ commitments, renewal windows, obligation extraction, and compliance-gap overlays — review-only; no automatic contract renewals, legal notices, tariff publishes, obligation status changes, or supplier document mutations from the sprint workflow.{" "}
          <strong>Sprint 24</strong> is Frontline &amp; Mobile Execution Intelligence (same workspace as AMP26 Frontline) for WMS/shipment/supplier task queues, evidence capture, quick actions, offline/latency risks, and supervisor review — review-only; no automatic task completion, inventory moves, shipment releases, or external messages from the sprint workflow.{" "}
          <strong>Sprint 25</strong> is Enterprise Knowledge &amp; Document Intelligence for AMP7 citation evidence, prompt-library drafts, training-review backlog, and release gate posture — review-only; no automatic SOP/policy publication, prompt promotion to production, knowledge-base overwrite, training export, or trusted extraction from the sprint workflow.{" "}
