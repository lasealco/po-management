...
import { ApihubWorkspaceStepper } from "../workspace-stepper";
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-zinc-600">
              ...
              on the home page. <span className="font-medium text-zinc-800">P2</span> ships async mapping analysis jobs,
              staging preview, and persisted batches. Access is org-scoped via{" "}
        ...
        <div className="mt-8 rounded-xl border border-zinc-200 bg-sky-50/80 p-5 shadow-sm">
