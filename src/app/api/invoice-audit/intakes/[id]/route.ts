  ...
  try {
    ...
    return NextResponse.json({
      intake: {
        ...
        financeHandoffStatus: row.financeHandoffStatus,
        financeHandoffSummary: row.financeHandoffSummary,
        disputeDraft: row.disputeDraft,
        accountingPacketJson: row.accountingPacketJson,
        financeHandoffUpdatedAt: row.financeHandoffUpdatedAt?.toISOString() ?? null,
