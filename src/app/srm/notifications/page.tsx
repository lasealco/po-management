      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-4">
          <WorkflowHeader
            ...
            description="Operator alerts (e.g. onboarding task assigned). G-v1: filter unread, mark all read, per-row mark read. Optional email (Resend) and outbound JSON webhook are env-only, off by default — see SRM operator notifications docs."
            steps={[]}
